...
import methodFirst from '@salesforce/apex/AsyncController.methodFirst';
import methodSecond from '@salesforce/apex/AsyncController.methodSecond';
import methodThird from '@salesforce/apex/AsyncController.methodThird';

export default class ImperativeServiceCallAllScenarios extends LightningElement {
    anyOrder() {
        console.log('\n\n Any Order');
        methodFirst()
            .then(result => {
